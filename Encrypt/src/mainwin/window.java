...
//		getContentPane().add(sp1);
		...
		start.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(encryptOrnot == true)
					start_working_encrypt();
				else 
					start_working_decrypt();
			}
		});
		...
		encrypt.setBounds(75, 561, 91, 23);
		...
		decrypt.setBounds(169, 561, 141, 23);
		...
		ButtonGroup encry = new ButtonGroup();
		encry.add(encrypt);
		encry.add(decrypt);
	}
	/*
	 ...
	 */
	public void start_working_encrypt(){
	...
	public void start_working_decrypt() {
		if(use_area == 0){
			JOptionPane.showConfirmDialog(null, "请选择明文输入方法！", "Wrong !", JOptionPane.ERROR_MESSAGE);
		}
		if(choosen_function == 0){
